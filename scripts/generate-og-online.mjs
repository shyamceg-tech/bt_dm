/**
 * scripts/generate-og-online.mjs
 *
 * One-off generator for the social-share image of the
 *   /digital-marketing-course-online landing page
 * at public/img/og-online.png (1200×630). Run with:
 *   node scripts/generate-og-online.mjs
 *
 * Same brand card as scripts/generate-og.mjs (fonts, gradient, tick), only the
 * copy is online / live-class-framed so the share card matches the page's
...
const OUT = path.join(__dirname, '..', 'public', 'img', 'og-online.png');
...
const HTML = `<!doctype html><html><head><meta charset="utf-8"><style>
  * { margin: 0; box-sizing: border-box; }
  ...
  .live-dot { width: 18px; height: 18px; border-radius: 50%; background: #34d399;
              box-shadow: 0 0 0 6px rgba(52,211,153,0.25); display: inline-block; }
  ...
  <div class="card">
    ...
    <div>
      <div class="eyebrow"><span class="live-dot"></span>Live Online &middot; Recordings Included</div>
      <div class="headline">Digital Marketing Course Online</div>
    </div>
    <div class="chips">
      <div class="chip">Live Classes, Real Mentors</div>
      <div class="chip">100% Placement Support</div>
      <div class="chip">Learn From Anywhere</div>
    </div>
  </div>
</body></html>`;
