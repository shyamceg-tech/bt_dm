...
const OUT = path.join(__dirname, '..', 'public', 'img', 'og-fees.png');
...
const HTML = `<!doctype html><html><head><meta charset="utf-8"><style>
  * { margin: 0; box-sizing: border-box; }
  ...
  <div class="card">
    ...
    <div>
      <div class="eyebrow">Transparent Fees &middot; No-cost EMI &middot; GST Included</div>
      <div class="headline">Digital Marketing Course Fees in Bangalore</div>
    </div>
    <div class="chips">
      <div class="chip">PCP &#8377;50,150 &middot; PGCP &#8377;89,680</div>
      <div class="chip">No-cost EMI from &#8377;5,000/mo</div>
