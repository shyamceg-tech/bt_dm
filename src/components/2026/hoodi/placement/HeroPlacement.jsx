/**
 * HeroPlacement.jsx (Hoodi branch) — placement-intent hero for the Hoodi page.
 * 1:1 copy of src/components/2026/placement/HeroPlacement.jsx (reuses the same
 * HeroOnline.module.css design + the shared HeroPlacementForm). Differs ONLY in
 * the location chip: Hoodi / Hoodi Junction instead of Indiranagar / Metro.
 */

import Image from 'next/image';
import HeroPlacementForm from '@/components/2026/placement/HeroPlacementForm';
import styles from '@/components/2026/online/HeroOnline.module.css';
...
/* Benefit chips — placement-tuned, Hoodi location swapped in. */
const CHIPS = [
