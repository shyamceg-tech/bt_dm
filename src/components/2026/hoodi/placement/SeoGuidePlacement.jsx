/* HOODI BRANCH copy of SeoGuidePlacement.jsx — noindex Google-Ads page.
...
const ITEMS = [
  ...
  {
    q: 'Placement support across Bangalore — from Hoodi to Whitefield',
    body: (
      <>
        <p>
          Our campus for the{' '}
          <strong>digital marketing course in Bangalore with placement</strong> is
          in Hoodi, a minute from Hoodi Junction on ITPL Road, with free
