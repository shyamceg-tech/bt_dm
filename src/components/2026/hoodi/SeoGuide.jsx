/* HOODI BRANCH copy of SeoGuide.jsx — noindex Google-Ads page.
...
const ITEMS = [
    ...
    body: (
      <>
        <p>
          ...
          <a href="/digital-marketing-course-near-me">Hoodi campus, a minute from Hoodi Junction</a>.
        </p>
        <p>
  ...
  {
    q: 'Areas in Bangalore we serve - from Hoodi to Whitefield',
    body: (
      <>
        <p>
          Our campus for{' '}
          <strong>digital marketing courses in Bangalore</strong> is in
          Hoodi at 104, 2nd Floor, ITPL Road, a 1-minute walk from
          Hoodi Junction, with free parking on site. It is
