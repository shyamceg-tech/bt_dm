/**
 * LocationProof.jsx (Hoodi branch) — Address + map + hours + landmarks.
 * Hoodi-branch twin of src/components/2026/near-me/LocationProof.jsx. Reuses the
 * shared LocationProof.module.css; pulls CAMPUS from the Hoodi config. Map uses
 * a keyless Google Maps coordinate embed.
 */

import { CAMPUS } from '@/data/hoodi/near-me.config';
import styles from '../../near-me/LocationProof.module.css';
      ...
      <div className={styles.container}>
        <header className={styles.head}>
          ...
          <h2 id="location-heading" className={styles.heading}>
            ...
            <span className={styles.heading_accent}>in Hoodi, a minute from Hoodi Junction</span>
          </h2>
          <p className={styles.lede}>
            On ITPL Road in the heart of Hoodi, a minute’s walk from Hoodi
            Junction. Easy to reach from Whitefield, Marathahalli, Brookefield,
            Mahadevapura and KR Puram - students travel in from across east
            Bangalore.
          </p>
        </header>
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.mapWrap}>
            <iframe
              ...
              title="BlueTick Academy - Hoodi campus map"
              allowFullScreen
            />
          </div>
        </div>
