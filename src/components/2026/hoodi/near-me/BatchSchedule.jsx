/**
 * BatchSchedule.jsx (Hoodi branch) — the real recurring timetable.
 * Hoodi-branch twin of src/components/2026/near-me/BatchSchedule.jsx. Reuses the
 * shared BatchSchedule.module.css; pulls SCHEDULE from the Hoodi config. Offline
 * is the featured/default option; online is the "can't make it in" fallback.
 * Server component.
 */

import { SCHEDULE } from '@/data/hoodi/near-me.config';
import styles from '../../near-me/BatchSchedule.module.css';
      ...
      <div className={styles.container}>
        <header className={styles.head}>
          ...
          <p className={styles.lede}>
            Classes run Monday to Friday. Offline at our Hoodi classroom on ITPL
            Road, a minute from Hoodi Junction, or live online for the days you
            can’t come in. Classroom batches are capped at {SCHEDULE.seatCap}.
          </p>
        </header>
