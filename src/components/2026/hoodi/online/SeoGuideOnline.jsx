/* HOODI BRANCH copy of SeoGuideOnline.jsx — noindex Google-Ads page.
    ...
    body: (
      <>
        ...
        <p>
          ...
          rooted in Hoodi (and across Bangalore) with 10,000+ alumni across MNCs and startups and a
    ...
    body: (
      <>
        ...
        <p>
          ...
          fixed place to study away from home, and can commute to our Hoodi
