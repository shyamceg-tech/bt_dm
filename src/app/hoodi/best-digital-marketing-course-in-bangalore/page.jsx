...
import BestHero from '@/components/2026/hoodi/best-course/BestHero';
...
import SeoGuideBest from '@/components/2026/hoodi/best-course/SeoGuideBest';     // reuses SeoGuide.module.css
import { CAMPUS } from '@/data/hoodi/near-me.config';
import { SAME_AS } from '@/data/social';
import { META } from '@/data/best-course.config';
import pageStyles from '@/app/best-digital-marketing-course-in-bangalore/page.module.css';
      ...
      hasCourseInstance: [
        {
          ...
          courseMode: 'Onsite',
          courseWorkload: 'P3M',
          location: { '@type': 'Place', name: 'BlueTick Academy — Hoodi, Bangalore' },
        },
        {
          '@type': 'CourseInstance',
