...
export const HERO = {
  ...
  subline:
    'Nine years. <em>10,000+ alumni placed</em> at MAANG, funded startups, and top agencies. We&rsquo;re ranked #1 by the only metric that matters &mdash; whether you actually get hired.',
  proofs: [
  ...
  formMicrotrust: 'No spam calls. We&rsquo;ll WhatsApp the comparison sheet within 12 mins.',
};
...
export const WHY_REASONS = [
  {
    ...
    body: 'Across our last 4 batches &mdash; 312 students, 303 placed. We publish named alumni with their LinkedIn profiles and current employers. Most &ldquo;Top 10&rdquo; institutes don&rsquo;t.',
    proof: '312 placed in last 4 batches',
  },
  {
    icon: 'spark',
    title: 'AI-native 2026 curriculum',
    body: 'Every module is rebuilt around the AI tools recruiters now expect on day one &mdash; ChatGPT, Gemini, Claude, Perplexity, Jasper, Copy.ai, Midjourney, plus 50+ more. Other &ldquo;Top 10&rdquo; institutes still teach a 2023 SEO syllabus.',
    proof: '50+ AI tools across 25 modules',
  },
  {
    icon: 'mic',
    title: 'Trainers running live campaigns',
    body: 'Not full-time career trainers. Our trainers are currently running brand budgets at agencies, startups and in-house teams &mdash; so the case study you study on Monday was their client meeting on Friday.',
  ...
  },
  {
    ...
    body: 'Nine years of relationships in the Bangalore agency, startup and MAANG ecosystem. The same recruiters keep coming back for our alumni &mdash; that&rsquo;s how the 97% number stays honest.',
...
export const FAQS = [
  {
    ...
    a: 'Three things, in order: (1) a 97% placement record verified across our last 4 batches with named alumni, (2) an AI-native curriculum rebuilt for how companies actually hire in 2026 &mdash; not a 2023 SEO syllabus, and (3) trainers who are currently running live ad budgets, not full-time career trainers. Everything else &mdash; awards, media, alumni at MAANG &mdash; is downstream of those three.',
  },
  {
  ...
  },
  {
    ...
    a: 'Mostly no. Most &ldquo;Top 10&rdquo; lists are paid SEO placements where institutes pay a fee or content commission to be listed. Don&rsquo;t pick by ranking article &mdash; pick by published placement data, named alumni, and a counselor call where you ask hard questions. We welcome the comparison.',
  },
  {
    q: 'How does BlueTick compare to IIDE, Simplilearn or other big-brand institutes?',
    a: 'Big-brand institutes optimise for marketing reach &mdash; we optimise for hiring outcome. Their batches run 80&ndash;200 students with full-time trainers; ours cap at 24 with practitioner trainers. Their curriculum is centralised and slow to update; ours is rebuilt every cohort around what Bangalore recruiters are actually asking for. Both models work for someone &mdash; ours works if your priority is placement.',
  },
  {
  ...
  },
  {
    ...
    a: 'Because the role itself has changed. A 2026 digital marketer is expected to ship campaigns 3&ndash;5x faster using AI tools &mdash; ChatGPT for copy, Gemini for research, Midjourney for creatives, Jasper/Copy.ai for variants, AI ad platforms like Meta Advantage+. Recruiters now filter resumes by AI fluency. An institute teaching a 2023 syllabus is sending you into a 2026 interview unprepared.',
  },
  {
    q: 'Who are the trainers and what&rsquo;s their pedigree?',
    a: 'All trainers have 5&ndash;12 years of current industry experience &mdash; running paid budgets at agencies (WPP, Dentsu, Madison), in-house teams (Swiggy, Razorpay, Cred) or their own consulting practice. We share full trainer profiles with LinkedIn links on the counselor call. No anonymous &ldquo;star faculty.&rdquo;',
  },
  {
    q: 'What if I don&rsquo;t get placed?',
    a: 'You stay in the placement pool until you do. We re-match you across batches, run additional mock interviews, sharpen your portfolio, and introduce you to recruiters from our 300+ partner network &mdash; for as long as it takes, at no additional fee. The 97% number isn&rsquo;t an end-of-course statistic; it&rsquo;s where we don&rsquo;t stop.',
  },
];
